...
print(f"Downloading pre-war data up to {end_date}...")
...
print("\nBest Sharpe Portfolio (Pre-War):")
print(best_sharpe)

df.to_csv("pre_war_optimization_results.csv")
print("\nResults saved to pre_war_optimization_results.csv")
