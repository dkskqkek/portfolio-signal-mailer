...
def generate_report():
    print("🚀 Generating Automated Verification Report...")

    report_lines = []
    report_lines.append(f"# Antigravity V4: 가설 검증 보고서 (Automated)")
    report_lines.append(
    ...
    if df_etf is not None:
        ...
        report_lines.append(
            f"*   **Action:** Replace Main Asset → **{winner['Ticker']}**"
        )
        report_lines.append("---\n")
    ...
    print(f"✅ Report automatically generated at: {output_path}")
